<template>
  <div>
    ...
    <van-tabs v-model="active" swipe-threshold="5" class="bottom">
      <van-tab title="全部" class="background1">
        <van-pull-refresh v-model="isLoading" @refresh="onRefresh" success-text="刷新成功" class="background2">
