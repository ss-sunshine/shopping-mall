  ...
  <div>
    ...
    <div>
        <van-tabs v-model="active">
          <van-tab v-for="(item,index) in classification[num].bxMallSubDto" :key="index" :title="item.mallSubName" ellipsis="false">内容 {{ index }}</van-tab>
        </van-tabs>
    </div>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    ...
    console.log(this.classification[num].bxMallSubDto);
  },
  watch: {},
  computed: {}
};
