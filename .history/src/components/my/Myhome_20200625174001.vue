<template>
  <div>
      ...
      <div class="ip f-c-a-j p-r">
        <van-icon name="setting" color="rgb(238,238,238)" class="right m-1" size="20px" @click="checksetting"/>
      ...
      <div class="f14">
        ...
        <van-cell-group>
          <van-cell icon="star-o" title="收藏商品" is-link @click="collec"/>
          <van-cell icon="home-o" title="地址管理" is-link />
          <van-cell icon="browsing-history-o" title="最近浏览" is-link />
        </van-cell-group>
        </div>
  </div>
</template>
