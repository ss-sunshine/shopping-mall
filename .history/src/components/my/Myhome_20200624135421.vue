<template>
  <div>
    ...
    <van-tabbar :fixed="false" class="nav" active-color="rgb(102,102,102)" inactive-color="rgb(102,102,102)">
      ...
      <van-tabbar-item icon="records" badge="20">评价</van-tabbar-item>
      <van-tabbar-item icon="points" badge="20">已完成</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
