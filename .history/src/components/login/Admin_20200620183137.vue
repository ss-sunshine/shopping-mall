    ...
    <div class="login m-lr-1">
      ...
      <div>
        <van-form @submit="onSubmit" class="m-r-1">
          ...
          <van-field center clearable label="验证码" placeholder="请输入验证码">
            <template #button>
              <van-button size="small" type="primary">发送验证码</van-button>
            </template>
          </van-field>
          <div class="d-f m-l-15">
            <div class="m-r-1 p-lr-3">
              <van-button type="primary" to="/">登录</van-button>
            </div>
            <div>
              <van-button type="danger" to="/">注册</van-button>
            </div>
          </div>
        </van-form>
      </div>
