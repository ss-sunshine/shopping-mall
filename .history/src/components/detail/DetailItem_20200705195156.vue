  ...
  <div>
    <div class="detail">
      ...
      <div class="wrapper" ref="wrapper">
        <div class="content">
          <van-swipe indicator-color="rgb(255,136,85)" :stop-propagation="false">
            <van-swipe-item>
              <img :src="detail.image" @click="lookImg(detail.image)"/>
            </van-swipe-item>
            <van-swipe-item>
              <img :src="detail.image_path" @click="lookImg(detail.image)"/>
            </van-swipe-item>
          </van-swipe>
          <div>
              ...
              <van-tab title="商品评价">
                ...
                <div class="p-tb-1">
                  <div v-if="arr.length>0">
                    <div class="d-f p-l-2" v-for="item in arr" :key="item.id">
                    <img src="../../assets/QQ.jpg" class="image" />
                    <div class="m-l-2">
                      <div class="f-a f14">
                        <div v-if="item.anonymous===false">{{nickname}}</div>
                        <div v-if="item.anonymous===true">{{name}}</div>
                      ...
                      <van-rate
                        ...
                        void-color="#eee"
                      />
                      <div class="m-tb-1 f14">{{item.content}}</div>
                    </div>
                  </div>
                  </div>
                  <div v-if="arr.length<1" class="f-j null">暂无评价~</div>
                </div>
              </van-tab>
            </van-tabs>
          </div>
      ...
      <van-goods-action class="shop-icon">
        ...
        <van-goods-action-icon v-if="shopList.length>0" icon="cart-o" text="购物车" @click="check" :badge="shopList.length" />
        <van-goods-action-icon v-if="shopList.length<1" icon="cart-o" text="购物车" @click="check" badge="" />
