<template>
  <div class="detail">
    ...
    <van-goods-action class="shop-icon">
      ...
      <van-action-sheet v-model="show" :title="detail.name" :src="detail.image" :round="false">
        <div class="addShop f14 price">￥{{detail.present_price}}</div>
        <img :src="detail.image" alt class="addShop-img" />s
      </van-action-sheet>
