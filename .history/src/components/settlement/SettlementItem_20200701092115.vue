    ...
    <div class="wrapper" ref="wrapper">
      <div class="content">
        ...
        <div v-if="idDirect === true">
          <van-cell-group>
            <van-card :title="detail.name">
              <template #thumb>
                <img :src="detail.image_path" class="content_img" />
              </template>
              <template #price>
                <div class="m-t-2 f-j-bw">
                  <span class="price f14 f-w-7">￥{{detail.present_price}}</span>
                  <span class="f14">x{{detail.count}}</span>
                </div>
              </template>
            </van-card>
          </van-cell-group>
